...
class BraintreeApi {
     ...
     */
    public function __construct($merchant_id,$public_key,$private_key,$clientside_key) {
        $this->environment = Yii::app()->params['braintreeapi']['environment'];
        $this->merchant_id = $merchant_id;
        $this->public_key = $public_key;
        $this->private_key = $private_key;
        $this->clientside_key = $clientside_key;
     ...
     */
    public function singleCharge($submitForSettlement = false, $storeInVaultOnSuccess = true) {
