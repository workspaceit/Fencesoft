...
class CCForm extends CWidget {
    ...
    private function registerScripts() {
        if(is_object($this->model->BraintreeApi))
        {
    ...
    public function renderAmount() {
        echo "<div class='well'><h4>Payment Submission</h4>";
            $value = isset($this->values['amount']) ? $this->values['amount'] : '';
            echo    "<div class='row control-group'>
                        <label class='control-label amount-label'>Amount($)</label><h5>Down-Payment Amount: <strong>$</strong><strong>{$value}</strong></h5>
                        <div class='controls'>
                        <input type='hidden' readonly='readonly' size='10' maxlength='10' autocomplete='off' name='BraintreeCCForm[amount]' value='{$value}' />
                        </div>
                    </div>";
        echo "</div>";
    }
    ...
    public function renderOrderId() {
        echo "<div class='well'><h4>Order Information</h4>";
            $value = isset($this->values['orderId']) ? $this->values['orderId'] : '';
            echo    "<div class='row control-group'>
                        <label class='control-label order-label'>Order ID</label><label class='valLable'><h5>Quote ID: <strong>{$value}</strong></h5></label>
                        <div class='controls'>
                        <input type='hidden' size='20' maxlength='50' autocomplete='off' name='BraintreeCCForm[orderId]' value='{$value}' />
                        </div>
                    </div>";
        echo "</div>";
    }
    ...
    public function renderCC() {
         echo "<div class='well'><h4>Billing Information</h4>";
            if(in_array('name',$this->fields_options['creditCard'])) {
                $value = isset($this->values['creditCard_name']) ? $this->values['creditCard_name'] : '';
                echo    "<div class='row control-group'>
							<ul>
								<li class='field'>
									<label class='control-label'>Name on Card</label><div class='controls'><input type='text' class='normal text' placeholder='Full Name' name='BraintreeCCForm[creditCard_name]' value='{$value}' /></div>
								</li>
							</ul>
                        </div>";
            }
            if(in_array('number',$this->fields_options['creditCard'])) {
                ...
                echo    "<div class='row control-group'>
							<ul>
								<li class='field'>
									<label class='control-label'>Card Number</label><div class='controls'><input type='text' class='normal text' placeholder='Card Number' autocomplete='off' name='BraintreeCCForm[creditCard_number]' /></div>
								</li>
							</ul>
                        </div>";
            }
            if(in_array('cvv',$this->fields_options['creditCard'])) {
                echo    "<div class='row control-group'>
							<ul>
								<li class='field'>
									<label class='control-label'>Security Code (CVV)</label><div class='controls'><input type='text' class='xnarrow text' placeholder='CVV' autocomplete='off' name='BraintreeCCForm[creditCard_cvv]' /></div>
								</li>
							</ul>
                        </div>";
            }
            if(in_array('date',$this->fields_options['creditCard'])) {
                ...
                echo    "<div class='row control-group'>
							<ul>
								<li class='field'>
									<label class='control-label'>Expiration Date (MM/YYYY)</label><div class='controls'><input type='text' class='narrow text' placeholder='Exp. Date' autocomplete='off' name='BraintreeCCForm[creditCard_date]' /></div>
								</li>
							</ul>
                        </div>";
            }
                ...
                echo    "<div class='row control-group'>
							<ul>
								<li class='field'>
									...
									<div class='controls'><input type='text' class='xxxnarrow text' placeholder='##' autocomplete='off' name='BraintreeCCForm[creditCard_month]' /> /&nbsp;&nbsp;<input type='text' class='xxnarrow text' placeholder='####' autocomplete='off' name='BraintreeCCForm[creditCard_year]' /></div>
								</li>
							</ul>
                        </div>";
            }
    ...
    public function renderCustomer() {
        echo "<div class='well'><h4>Customer Information</h4>";
            if(in_array('firstName',$this->fields_options['customer'])) {
                ...
                echo    "<div class='row control-group'>
							<ul>
								<li class='field'>
									<label class='control-label'>First Name</label><div class='controls'><input type='text' class='normal text' placeholder='First Name' name='BraintreeCCForm[customer_firstName]' value='{$value}' /></div>
								</li>
							</ul>
                        </div>";
            }
            if(in_array('lastName',$this->fields_options['customer'])) {
                ...
                echo    "<div class='row control-group'>
							<ul>
								<li class='field'>
									<label class='control-label'>Last Name</label><div class='controls'><input type='text' class='normal text' placeholder='Last Name' name='BraintreeCCForm[customer_lastName]' value='{$value}' /></div>
								</li>
							</ul>
                        </div>";
            }
            if(in_array('company',$this->fields_options['customer'])) {
                ...
                echo    "<div class='row control-group'>
							<ul>
								<li class='field'>
									<label class='control-label'>Company Name</label><div class='controls'><input type='text' class='normal text' name='BraintreeCCForm[customer_company]' value='{$value}' /></div>
								</li>
							</ul>
                        </div>";
            }
            if(in_array('email',$this->fields_options['customer'])) {
                ...
                echo    "<div class='row control-group'>
							<ul>
								<li class='field'>
									<label class='control-label'>Email Address</label><div class='controls'><input type='text' class='normal text' placeholder='Email' name='BraintreeCCForm[customer_email]' value='{$value}' /></div>
								</li>
							</ul>
                        </div>";
            }
            if(in_array('phone',$this->fields_options['customer'])) {
                ...
                echo    "<div class='row control-group'>
							<ul>
								<li class='field'>
									<label class='control-label'>Phone Number</label><div class='controls'><input type='text' class='narrow text' placeholder='Phone' name='BraintreeCCForm[customer_phone]' value='{$value}' /></div>
								</li>
							</ul>
                        </div>";
            }
    ...
    public function renderBilling() {
        echo "<div class='well'><h4>Billing Info</h4>";
    ...
    public function renderShipping() {
        echo "<div class='well'><h4>Shipping Info</h4>";
