...
class BraintreeCCForm extends CFormModel {
    ...
    public function __construct($scenario = '',$marchant_id,$public_key,$private_key,$clientside_key) {
        Yii::import('ext.BraintreeApi.BraintreeApi');
        if($marchant_id!="" && $public_key!="" && $private_key!="" && $clientside_key!="")
        $this->BraintreeApi = new BraintreeApi($marchant_id,$public_key,$private_key,$clientside_key);
