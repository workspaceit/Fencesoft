	...
	<div class="four columns">
		<div class="widget">
			...
			<form action="<?php echo Yii::app()->request->baseUrl;?>/index.php?r=users/login" method="post">
				<div id="login-fields">
					<ul>
						<li class="field"><input name="LoginForm[username]" placeholder="User Name" type="text" class="xwide text" value="" /></li>
						<li class="field append"><input name="LoginForm[password]" placeholder="Password" type="password" class="normal text" value="" style="width:66%;" />
