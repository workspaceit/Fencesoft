		...
		<h3>Select Your Material, Choose the Size and Color Option Below...</h3>
            ...
            ?>
                <li class="silo-img">
            	    ...
            	    ?>
            		<a class="click-sub-material" href="<?php  echo Yii::app()->request->baseUrl.'/index.php?r=index/estimation&fence_type=Aluminum&fence_id='.$data['id']; ?>" title="Click to select this material"><img src="<?php  echo $featuredImage; ?>" alt="" /></a>
                	<h5>
                	    <a class="click-sub-material" href="<?php  echo Yii::app()->request->baseUrl.'/index.php?r=index/estimation&fence_type=Aluminum&fence_id='.$data['id']; ?>" title="Click to select this material">
                	        <?php
