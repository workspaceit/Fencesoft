...
<head></head>
<body>
<style> .veranda, .freedom {display:none;}</style>
<table style="width:100%; border-bottom:1px solid #efefef; padding-bottom:10px; margin-bottom:13px;">
	<tr>
		<td><img src="<?php echo Yii::app()->basePath.'/../images/ActiveYards.png'; ?>" /></td>
	<tr>
</table>
<table style="background:#efefef; width:100%; padding:10px;">
	...
	<tr>
		<td style="height:16px;"><span style="font-size:12px;"><?php echo $storeData['site_name'].' - '.ucwords(str_replace('_', ' ', $storeData['network_type']));?> - Dealer # <?php echo $storeData['store_id'];?></span></td>
...
<table style="width:100%; border-top:1px solid #efefef; padding-top:13px; margin-top:10px;">
	<tr>
		<td style="text-align:center;"><span style="font-size:12px; color:#666;">&copy; 2014 Active Yards. All rights reserved. | Powered by: FenceSoft &reg;</span></td>
	</tr>
</table>
</body>
</html>