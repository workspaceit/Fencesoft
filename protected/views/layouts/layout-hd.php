...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<title>Home Depot Fence Estimation</title>
	...
	<body>
	    ...
	    <div class="row">
	        <div class="six columns">
				<a id="qtip-Home" href="<?php echo Yii::app()->request->baseUrl;?>/index.php?r=index/index"><img class="fs-logo" src="<?php echo Yii::app()->request->baseUrl; ?>/images/Veranda.png" alt="Veranda" /></a>
	        </div>
	    ...
	    <script type="text/javascript">
	    	...
	    	$(function(){
	    		...
	    		$('.second-nav-item').on('click','a',function(e){
		    		e.preventDefault();
		    		notif({
		...
		<script type="text/javascript">
			...
			$('#qtip-StoreInfo').qtip({id:'StoreInfo', content:{title:'Your Local Store Information', text:'The above is the Home Depot store nearest to you based on your zip-code.  If you would like to change to a different store location, click on <a href="#">More Info</a> above.', button:true}, style:{classes:'qtip-bootstrap'}, show:{delay:1000, solo:true, effect:function(offset){$(this).fadeIn(500);}}, hide:{delay:1000, fixed:true, effect:function(offset){$(this).fadeOut(1000);}}, position:{at:'bottom center', my:'top center'}});
