...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<title><?php echo $this->siteDetails['site_name'];?> Fence Estimation</title>
		...
		<link rel="stylesheet" type="text/css" media="all" href="<?php echo Yii::app()->request->baseUrl; ?>/css/fencesoft-mods.css">
		<link rel="stylesheet" type="text/css" media="all" href="<?php echo Yii::app()->request->baseUrl; ?>/css/sites/<?php echo $this->siteDetails['store_id'];?>.css">
		<script>
	...
	<body>
	    ...
	    <div class="row">
	        <div class="six columns">
				<a id="qtip-Home" href="<?php echo Yii::app()->request->baseUrl;?>/index.php?r=index/index"><img class="fs-logo" src="<?php echo Yii::app()->request->baseUrl; ?>/images/logos/<?php echo $this->siteDetails['store_id'];?>.png" alt="<?php echo $this->siteDetails['site_name'];?>" /></a>
	        </div>
	        <div class="three columns widget-box">
	            <div class="widget location-info">
					<!--<i class="icon-info-circled"></i>-->
					<div class="location-info-centered">
						<h5 class="tool-tip"><?php echo $this->siteDetails['site_name'];?></h5>
						<h4><?php echo $this->siteDetails['phone'];?></h4>
	        ...
	        <div class="three columns widget-box">
	            ...
	            <?php if(Yii::app()->session['isLogin']):?>
					<h5>Welcome back, <?php echo Yii::app()->session['profile']['full_name'];?></h5>
					<p><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=index/estimation&fence_type=Vinyl&fence_id=1">View Recent Quotes</a></p>
	    ...
	    <div class="pretty navbar row" id="nav3">
	        <div class="row">
	            ...
	            <ul class="six columns">
	                <li class="first-nav-item"><a id="qtip-materialSection" href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=index/index"><i class="icon-home"></i> Material Selection</a></li>
	    ...
	    <div id="footer" class="row">
	        <div class="six columns left-align">
				<p class="copy2">&copy; 2014 <?php echo $this->siteDetails['site_name'];?>. All rights reserved. | <a href="<?php echo Yii::app()->request->baseUrl;?>/index.php?r=index/termsAndConditions" target="_blank">Terms &amp; Conditions</a></p>
	        </div>
		...
		<script type="text/javascript">
			...
			$('#qtip-StoreInfo').qtip({id:'StoreInfo', content:{title:'Dealer Information', text:'<?php echo $this->siteDetails['site_name'];?><br /><?php echo $this->siteDetails['location'];?>, <?php echo $this->siteDetails['city'];?>, <?php echo $this->siteDetails['state'];?> <?php echo $this->siteDetails['zip_code'];?><br /><?php echo $this->siteDetails['phone'];?>', button:true}, style:{classes:'qtip-bootstrap'}, show:{event:'click', solo:true, effect:function(offset){$(this).fadeIn(500);}}, hide:{delay:3000, fixed:true, effect:function(offset){$(this).fadeOut(1000);}}, position:{at:'bottom center', my:'top center'}});
			...
			$('#canvas-container').qtip({
				id:'canvas-container',
				content:{title:'How to Design Your Fence Plan', text:'1. Set the scale of the drawing grid by choosing either 50ft, 100ft, 250ft or 500ft from the drop-down option in the toolbar.<br /><br />2. Draw your lengths of fence by double-clicking your mouse on the drawing grid at the starting point, then double-click again to release the line at the desired end-point.<br /><br />3. You may connect two lines with an intersecting corner post by dragging and dropping one point onto another.<br /><br />4. In order to add gates to your drawing, simply choose your gate from the gate drop-down to the left, then drag and drop the gate object icon to the drawing grid.<br /><br />5. Dragging and dropping other object icons from the toolbar (such as buildings, decks, trees and pools) allows you to apply these elements for reference in your plan.<br /><br /><strong>For further instructions, check out this quick <a href="#">video tutorial</a>.</strong><br /><br />', button:true},
				style:{classes:'qtip-bootstrap qtip-mods'},
				show:{solo:true, event:'click', effect:function(offset){$(this).fadeIn(1000);}},
				hide:{delay:100, fixed:true, effect:function(offset){$(this).fadeOut(1000);}},
