...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<title>ActiveYards Fence Estimation</title>
		...
		<link rel="stylesheet" type="text/css" media="all" href="<?php echo Yii::app()->request->baseUrl; ?>/css/ay-mods.css">
		<script>
	...
	<body>
	    ...
	    <div class="row">
	        <div class="six columns">
				<a id="qtip-Home" href="<?php echo Yii::app()->request->baseUrl;?>/index.php?r=index/index"><img class="fs-logo" src="<?php echo Yii::app()->request->baseUrl; ?>/images/ActiveYards.png" alt="ActiveYards" /></a>
	        </div>
	        <div class="three columns widget-box">
	            <div class="widget location-info">
					<i class="icon-info-circled"></i>
					<div class="location-info-centered">
						<h5 class="tool-tip">Your Local Dealer Information</h5>
	    ...
	    <div id="footer" class="row">
	        <div class="six columns left-align">
				<p class="copy2">&copy; 2014 ActiveYards. All rights reserved. | <a href="#">Terms &amp; Conditions</a></p>
	        </div>
		...
		<script type="text/javascript">
			...
			$('#qtip-StoreInfo').qtip({id:'StoreInfo', content:{title:'Your Local Dealer Information', text:'The above is the Active Yards dealer nearest to you based on your zip-code.  If you would like to change to a different dealer location, click on <a href="#">More Info</a> above.', button:true}, style:{classes:'qtip-bootstrap'}, show:{delay:1000, solo:true, effect:function(offset){$(this).fadeIn(500);}}, hide:{delay:1000, fixed:true, effect:function(offset){$(this).fadeOut(1000);}}, position:{at:'bottom center', my:'top center'}});
